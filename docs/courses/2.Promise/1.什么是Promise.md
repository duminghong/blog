...
flowchart LR
  %% 定义样式类
  classDef container fill:#f5f5f5,stroke:#ddd,stroke-width:1px;
  classDef pendingNode fill:#ffcc00,color:#333,stroke:#cc9900,stroke-width:1.5px;
  classDef fulfilledNode fill:#66cc66,color:#333,stroke:#339933,stroke-width:1.5px;
  classDef rejectedNode fill:#ff6666,color:#333,stroke:#cc3333,stroke-width:1.5px;
